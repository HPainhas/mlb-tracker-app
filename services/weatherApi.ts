...
const OPENWEATHER_API_KEY = process.env.EXPO_PUBLIC_OPENWEATHER_API_KEY || 'your_api_key_here';
...
const BALLPARK_LOCATIONS: { [key: string]: BallparkLocation } = {
  ...
  'Progressive Field': { name: 'Progressive Field', lat: 41.4962, lon: -81.6852 },
  'Comerica Park': { name: 'Comerica Park', lat: 42.339, lon: -83.0487 },
  'Guaranteed Rate Field': { name: 'Guaranteed Rate Field', lat: 41.83, lon: -87.6338 },
  ...
  'Citizens Bank Park': { name: 'Citizens Bank Park', lat: 39.9061, lon: -75.1665 },
  'Nationals Park': { name: 'Nationals Park', lat: 38.8730, lon: -77.0074 },
  'Wrigley Field': { name: 'Wrigley Field', lat: 41.9484, lon: -87.6553 },
  'Great American Ball Park': { name: 'Great American Ball Park', lat: 39.0975, lon: -84.5061 },
  'American Family Field': { name: 'American Family Field', lat: 43.0280, lon: -87.9712 },
  ...
  'Dodger Stadium': { name: 'Dodger Stadium', lat: 34.0739, lon: -118.2400 },
  'Petco Park': { name: 'Petco Park', lat: 32.7073, lon: -117.1566 },
  'Oracle Park': { name: 'Oracle Park', lat: 37.7786, lon: -122.3893 }
};

export const getWeatherForVenue = async (venueName: string): Promise<WeatherData | null> => {
  try {
